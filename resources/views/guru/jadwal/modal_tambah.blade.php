                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="date" id="tanggal" class="form-control" name="tanggal_konseling" required />
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="time" id="jam" class="form-control" name="jam_konseling" required />
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <sup class="text-danger">* berikan keterangan singkat, dimana keterangan ini akan dikirimkan
                                secara otomatis ke anda sesuai dengan jadwal sebagai pengingat</sup>
                        </div>
                    </div>
                </div>
