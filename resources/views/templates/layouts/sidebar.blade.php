...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">cybco</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        <!-- Dashboard -->
        <li class="menu-item {{ Request::is($user->role) ? 'active' : ''}}">
            <a href="{{ route('dashboard.'.$user->role) }}" class="menu-link">
